...
CHAIN BFDNAIMA bfs.checkmate
~It does sound rather counter-productive.~
END
IF ~~ EXTERN BFDNAIMA bfs.trialhub

CHAIN BFDNAIMA bfs.wisewords
...
END
+ ~GlobalGT("bfsnaimanconvinced","GLOBAL",6)~ + ~Yaga-Shura destroyed Saradush. The city did not fall by my hand.~ EXTERN BFDNAIMA bfs.iknowthisandloveyou
+ ~GlobalGT("bfsnaimanconvinced","GLOBAL",6)~ + ~Blame me if you like, but I didn't choose this madness.~ EXTERN BFDNAIMA bfs.iknowthisandloveyou
+ ~GlobalGT("bfsnaimanconvinced","GLOBAL",6)~ + ~Causation does not prove guilt. I was not present in Saradush, nor did I order its destruction.~ EXTERN BFDNAIMA bfs.iknowthisandloveyou
+ ~GlobalGT("bfsnaimanconvinced","GLOBAL",6)~ + ~I have nothing more to add.~ EXTERN BFDNAIMA bfs.iknowthisandloveyou
+ ~GlobalLT("bfsnaimanconvinced","GLOBAL",7)~ + ~Yaga-Shura destroyed Saradush. The city did not fall by my hand.~ EXTERN BFDNAIMA bfs.doesntengendertrust
+ ~GlobalLT("bfsnaimanconvinced","GLOBAL",7)~ + ~Blame me if you like, but I didn't choose this madness.~ EXTERN BFDNAIMA bfs.doesntengendertrust
+ ~GlobalLT("bfsnaimanconvinced","GLOBAL",7)~ + ~Causation does not prove guilt. I was not present in Saradush, nor did I order its destruction.~ EXTERN BFDNAIMA bfs.doesntengendertrust
+ ~GlobalLT("bfsnaimanconvinced","GLOBAL",7)~ + ~I have nothing more to add.~ EXTERN BFDNAIMA bfs.doesntengendertrust
