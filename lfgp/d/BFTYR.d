...
~The rot that festered within my court has revealed itself. Justice, at last, has been served.~ [BFBLANK]
...
~The shadow of Cyric's brood darkens Lunia's shores no further. You have earned my gratitude, <CHARNAME>. Not merely for your assistance in dealing with these invaders, but for the grace with which you bore false accusations.~
...
== IMOEN25J IF ~InParty("IMOEN2") InMyArea("IMOEN2") !StateCheck("IMOEN2",CD_STATE_NOTVALID)~ THEN ~I hope his praise won't go to your head, <CHARNAME>. I mean, you *did* earn it, but still.~
== VICON25J IF ~InParty("VICONIA") InMyArea("VICONIA") !StateCheck("VICONIA",CD_STATE_NOTVALID)~ THEN ~A god's favor? Hmph. Be wary, <CHARNAME>. Gifts from deities often come with chains you cannot see.~
