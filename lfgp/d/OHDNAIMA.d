...
+ ~GlobalLT("bfsstrtrial","GLOBAL",1) CheckStatGT(Player1,16,STR)~ + ~You ask for words, but I speak best with my fists. I've destroyed others far stronger than you.~ DO ~IncrementGlobal("bfsstrtrial","GLOBAL",1) IncrementGlobal("bfsnaimanconvinced","GLOBAL",-1)~ EXTERN OHDNAIMA bfs.weirdflex
...
~I have heard of your deeds. Some among the faithful swore adding your name to the scroll would be an injustice. It is likely one of them summoned you here. How irresponsible of me to forget such a detail.~
END
...
~I-I refuse to be intimidated! If anything it reinforces the necessity of my scrutiny.~
END
IF ~~ EXTERN OHDNAIMA bfs.trialhub
...
~You extended your protection to one city, yet supposedly wrought ruin upon another. I will take this anomaly into account.~
END
IF ~~ EXTERN OHDNAIMA bfs.trialhub
